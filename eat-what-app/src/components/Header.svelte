    ...
    <div class="container">
        <div class="nav-brand">
            <a href="https://nostalgic-css.github.io/NES.css/"
                ><h1><i class="snes-jp-logo brand-logo" />NES.css</h1></a
            >
            <p>NES-style CSS 框架.</p>
        </div>
        <div class="social-buttons">
            ...
            <div class="share">
                <a
                    ...
                    target="_blank"><i class="nes-icon twitter" /></a
                >
                <a
                    ...
                    target="_blank"><i class="nes-icon facebook" /></a
                >
                <a
                    ...
                    target="_blank"><i class="nes-icon linkedin" /></a
                >
                <a
                    href="https://github.com/nostalgic-css/NES.css"
                    target="_blank"><i class="nes-icon github" /></a
                >
            </div>
        </div>
    </div>
